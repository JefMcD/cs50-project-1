...
def make_backup_file(wiki_page):
    print('########################################################')
    print('########################################################')
    print('###    jefmcd2html.make_backup_file                #####')
    print('########################################################')
    print('########################################################')
    print('########################################################')
...
def test_environment(md_file):
    print('########################################################')
    print('########################################################')
    print('###    jefmcd2html.test_environment                #####')
    print('########################################################')
    print('########################################################')
    print('########################################################')
    #establish where we are
...
def parse_ul_tags(line, open_rx, markdown_tag, html_open_tag, html_close_tag, first_li_flag):
    print('########################################################')
    print('########################################################')
    print('###    jefmcd2html.parse_ul_tags                   #####')
    print('########################################################')
    print('########################################################')
    print('########################################################')
...
def strip_brackets_from_parenthesis(md_link, pattern, left_regex, right_regex):
    print('########################################################')
    print('########################################################')
    print('###    jefmcd2html.strip_brackets_from_parenthesis #####')
    print('########################################################')
    print('########################################################')
    print('########################################################')
...
def parse_link_tags(line):
    print('########################################################')
    print('########################################################')
    print('#####    jefmcd2html.parse_link_tags    ################')
    print('########################################################')
    print('########################################################')
    print('########################################################')
    """
    ...
    link_pattern = re.compile(r'\[.+\]\(.+\)') # anchor tag
    link_is_an_img =  False
    if link_pattern.search(line):
        ...
        for match in matches:
            ...
            count = len(raw_url_link)
            i=0
            link_type_rx = re.compile(r'!\[')
            while i < count:
                if link_type_rx.search(line): # if img link
                    print(f'>>>>>>>>PASS {i} link => {raw_url_link[i]}\n')
                    print(f'>>>>>>>>PASS {i} raw_link_text => {raw_link_text[i]}\n')
                    html_urls.append(f"<a href='{raw_url_link[i]}'><img src='{raw_link_text[i]}'></a>")
                    link_is_an_img = True
                else: # standard link
                    print(f'PASS {i} link => {raw_url_link[i]}\n')
                    print(f'PASS {i} raw_link_text => {raw_link_text[i]}\n')
            ...
            if link_is_an_img:
                kick_exclamation_mark = re.compile(r'!')
                new_string = kick_exclamation_mark.sub('',new_string)
...
def translate_md2html(md_file):
    print('########################################################')
    print('########################################################')
    print('#####    jefmcd2html.translate_md2html  ################')
    print('########################################################')
    print('########################################################')
    print('########################################################')
    #establish where we are
